...
class _WardFinderiFrameState extends State<ItemSpendingiFrame> {
  ...
  void initState() {
    ...
    _iFrameElementmap.src = 'https://clairehemmerly.maps.arcgis.com/apps/mapviewer/index.html?webmap=9b5a78f278b543518468de63c6d87331';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(title: const Text('Menu Item Locations'),),
      body: Center(
        child: Column(
          children: [
            SizedBox(
                  ...
                  children: [
                    TextSpan(
                      ...
                      recognizer: TapGestureRecognizer()
                        ..onTap = () async {
                          if (await canLaunchUrl(Uri.parse('https://clairehemmerly.maps.arcgis.com/apps/mapviewer/index.html?webmap=9b5a78f278b543518468de63c6d87331'))) {
                            await launchUrl(Uri.parse('https://clairehemmerly.maps.arcgis.com/apps/mapviewer/index.html?webmap=9b5a78f278b543518468de63c6d87331'));
                          } else {
